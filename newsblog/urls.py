...
from newsblog.views import ArticleListView, ArticleCreateView, ArticleDetailView, ArticleUpdateView,  ArticleDeleteView, ArticleListViewNegative
...
#    path('', index, name='index'),
    ...
    path('invisible/', ArticleListViewNegative.as_view(), name='listallarticles_negative'),
...
#    path('view/<str:slug>/', ArticleDetailView.as_view(), name='view_single_article'),
